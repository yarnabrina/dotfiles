...
# Reference: "${HOME}"/dotfiles/unix-like/tools/gitstatus/gitstatus.prompt.sh

source "${HOME}"/dotfiles/unix-like/tools/gitstatus/gitstatus.plugin.sh
...
PS1+='\[\033[01;33m\]\u\[\033[00m\]'              ## orange username
PS1+='\[\033[01;37m\] at \[\033[00m\]'            ## separator between user and host
PS1+='\[\033[01;33m\]\h\[\033[00m\]'              ## yellow hostname
PS1+='\[\033[01;37m\] in \[\033[00m\]'            ## separator between host and directory
PS1+='\[\033[01;34m\]\w\[\033[00m\]'              ## green working directory
